...
sensor_var initI2c(void) {
	...
	// Empty sensor_info
	sensor_info.acceleration_mg[0] = NAN;
	sensor_info.acceleration_mg[1] = NAN;
	sensor_info.acceleration_mg[2] = NAN;
	sensor_info.angular_rate_dps[0] = NAN;
	sensor_info.angular_rate_dps[1] = NAN;
	sensor_info.angular_rate_dps[2] = NAN;
	sensor_info.lps22hhpressure_hPa = NAN;
	sensor_info.lps22hhTemperature_degC = NAN;
	...
	sensor_info.acceleration_mg[0] = acceleration_mg[0];
	sensor_info.acceleration_mg[1] = acceleration_mg[1];
	sensor_info.acceleration_mg[2] = acceleration_mg[2];
	sensor_info.angular_rate_dps[0] = angular_rate_dps[0];
	sensor_info.angular_rate_dps[1] = angular_rate_dps[1];
	sensor_info.angular_rate_dps[2] = angular_rate_dps[2];
	sensor_info.lps22hhpressure_hPa = pressure_hPa;
	sensor_info.lps22hhTemperature_degC = lps22hhTemperature_degC;
